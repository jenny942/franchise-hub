...
export default function ResetPasswordPage() {
  ...
  return (
    <div style={{
      minHeight: '100vh', background: '#E6F1F4',
      display: 'flex', alignItems: 'center', justifyContent: 'center',
      padding: '2rem', fontFamily: "'Open Sans', sans-serif",
    }}>
      <div style={{
        background: '#fff', borderRadius: '20px', width: '100%', maxWidth: '440px',
        padding: '2.5rem 2.5rem 2rem', border: '0.5px solid #A7DBE7',
      }}>
        {/* Logo */}
        <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
          <div style={{
            width: '56px', height: '56px', background: '#5AB3C9',
            borderRadius: '14px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: '0.75rem',
          }}>
        ...
        {done ? (
          <div style={{ textAlign: 'center', padding: '1rem 0' }}>
            ...
            <p style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 800, fontSize: '18px', color: '#2C3E50', margin: '0 0 0.5rem' }}>Password set!</p>
            <p style={{ fontSize: '13.5px', color: '#888' }}>Taking you to your dashboard…</p>
          </div>
        ) : !ready ? (
          <div style={{ textAlign: 'center', padding: '1rem 0' }}>
            <p style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 800, fontSize: '20px', color: '#2C3E50', margin: '0 0 0.5rem' }}>Set your password</p>
            <p style={{ fontSize: '13.5px', color: '#aaa' }}>Verifying your reset link…</p>
          </div>
        ) : (
          <>
            <p style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 800, fontSize: '20px', color: '#2C3E50', margin: '0 0 0.25rem' }}>Set your password</p>
            <p style={{ fontSize: '13.5px', color: '#888', margin: '0 0 1.5rem' }}>Choose a password to access your dashboard.</p>
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                style={{ width: '100%', height: '44px', border: '1.5px solid #A7DBE7', borderRadius: '10px', padding: '0 14px', fontSize: '14.5px', fontFamily: "'Open Sans', sans-serif", color: '#2C3E50', background: '#fff', boxSizing: 'border-box', outline: 'none', marginBottom: '1rem' }}
              />
              <label style={{ fontSize: '12px', fontWeight: 600, color: '#2C3E50', letterSpacing: '0.5px', textTransform: 'uppercase', display: 'block', marginBottom: '6px' }}>
                Confirm password
              </label>
